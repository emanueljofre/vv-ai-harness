...
| **Web Services (REST API)**         | In Progress | `web-services/` (148 baselined on WADNR 2026-04-10 + 17 V2-baselined on vv5dev 2026-04-22 + 18 backlog — WS-11/12/13 new 2026-04-20). **V1/V2 parity confirmed (2026-04-22)**: vvdemo V1 (`b18dbfdb`) and vv5dev V2 (`f36b65dd`) produce byte-identical verdicts at all 79 audit slots — no regression on the API write path. The `useUpdatedCalendarValueLogic` toggle is Forms-only. |
