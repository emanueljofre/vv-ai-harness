...
| **Web Services (REST API)**         | In Progress | `web-services/` (148 baselined on WADNR 2026-04-10 + 17 V2-baselined on vv5dev 2026-04-22 + 18 backlog — WS-11/12/13 new 2026-04-20). **V2 finding: no regression on the API write path — 59 IDENTICAL vs V1 matrix; the 1 KNOWN_BUG is legacy FORM-BUG-7 from an IST-saved reference record.** |
