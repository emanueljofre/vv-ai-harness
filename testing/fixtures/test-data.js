...
const TEST_DATA = [
    ...
    },
    {
        ...
        notes: 'V2 behavior change vs V1: epoch-ms SFV input is preserved as a number in raw (1773543600000) instead of being coerced to an ISO string. Side effect: GFV returns null because the V2 GFV pipeline does not handle numeric raws. V1 normalized epoch→ISO so GFV was a real UTC. See FORM-BUG-V2-EPOCH-PRESERVED.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-7-C-epoch.md',
    },
    ...
    },
    {
        ...
        expectedApi: null,
        bugs: ['FORM-BUG-V2-EPOCH-PRESERVED'],
        notes: 'V2 behavior change vs V1: epoch-ms SFV input is preserved as a number in raw (1773543600000) instead of being coerced to an ISO/date string. Side effect: GFV returns null because the V2 GFV pipeline does not handle numeric raws. V1 normalized epoch→date string so GFV was a clean ISO/date-only. See FORM-BUG-V2-EPOCH-PRESERVED.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-7-A-epoch.md',
    },
    ...
    },
    {
        ...
        expectedRaw: '',
        expectedApi: '',
        bugs: ['FORM-BUG-V2-SAVE-RELOAD-EMPTY'],
        notes: 'V2 regression vs V1: Config C save+reload loses the value entirely. V1 stored the naive datetime through the server round-trip; V2 reload returns empty raw + empty api. setFieldValue pre-save check passes (value is populated in partition), so the loss happens in the save→persist→reload pipeline. Config D sibling (14-D-save.V2) and all 16-*-controls.V2 entries exhibit the same behavior. See FORM-BUG-V2-SAVE-RELOAD-EMPTY.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-14-C-save.md',
    },
    {
        id: '14-D-save',
    ...
    },
    {
        ...
        expectedApi: '',
        bugs: ['FORM-BUG-V2-SAVE-RELOAD-EMPTY'],
        notes: 'V2 regression vs V1: Config D save+reload loses the value entirely (V1 had FORM-BUG-5 fake-Z; V2 behavior differs — value is lost, not Z-appended). Same root cause as 14-C-save.V2 / 16-*-controls.V2. See FORM-BUG-V2-SAVE-RELOAD-EMPTY.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-14-D-save.md',
    },
    {
        id: '14-C-API',
    ...
    },
    {
        ...
        expectedApi: '',
        bugs: ['FORM-BUG-V2-SAVE-RELOAD-EMPTY'],
        notes: 'V2 regression vs V1: Config A save+reload loses the value entirely. Same root cause as 14-*-save.V2 and 16-C-controls.V2. V1 preserved the raw through server round-trip; V2 reload returns empty. See FORM-BUG-V2-SAVE-RELOAD-EMPTY.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-16-A-controls.md',
    },
    {
        id: '16-C-controls',
    ...
    },
    {
        ...
        expectedApi: '',
        bugs: ['FORM-BUG-V2-SAVE-RELOAD-EMPTY'],
        notes: 'V2 regression vs V1: Config C save+reload loses the value entirely. Same root cause as 14-*-save.V2 and 16-A-controls.V2. V1 preserved raw T00:00:00 through round-trip; V2 reload returns empty. See FORM-BUG-V2-SAVE-RELOAD-EMPTY.',
        tcRef: 'research/date-handling/forms-calendar/test-cases/tc-16-C-controls.md',
    },
    {
        id: '16-D-controls',
